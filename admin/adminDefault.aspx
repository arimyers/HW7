<%@ Page Title="" Language="VB" MasterPageFile="~/Golf.master" AutoEventWireup="false" CodeFile="adminDefault.aspx.vb" Inherits="admin_Default" %>
    ...
    <div class="center">
        ...
        <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" DataSourceID="sqlHome" Height="225px" HorizontalAlign="Center" style="font-size: large" Width="663px" CssClass="views">
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="golferID" DataNavigateUrlFormatString="adminGolfer.aspx?golferID={0}" Text="Select" >
